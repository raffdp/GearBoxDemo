...
const setupExplode = (asset) => {
  ...
  const explodedAmountRouter = asset.addChild(new RouterOperator('ExplodeAmountRouter'));
  ...
  const labelOpacityRouter = asset.addChild(new RouterOperator('LabelOpacityRouter'));
  ...
  asset.once('loaded', () => {
    ...
    }
    {
      ...
      group.getParameter('InitialXfoMode').setValue('average');
      asset.addChild(group);
      group.resolveItems([['.', 'PROPELLER_HOUSING_ASSM_ASM', 'PROPELLER_HOUSING']]);
      const part = opExplodeFront1.getParameter('Parts').addElement();
      part.getParameter('Axis').setValue(new Vec3(0, -1, 0));
      part.getOutput().setParam(group.getParameter('GlobalXfo'));
    }
    {
      ...
      group.getParameter('InitialXfoMode').setValue('average');
      asset.addChild(group);
      group.resolveItems([['.', 'PROPELLER_HOUSING_ASSM_ASM', '60-80-10_OIL_SEAL']]);
      const part = opExplodeFront1.getParameter('Parts').addElement();
      part.getParameter('Axis').setValue(new Vec3(0, -1, 0));
      part.getOutput().setParam(group.getParameter('GlobalXfo'));
    }
    ...
    }
    {
      ...
      group.getParameter('InitialXfoMode').setValue('average');
      asset.addChild(group);
      group.resolveItems([['.', 'GEAR_HOUSING_ASSM_ASM', 'U-SEAL_FOR_GEAR_HOUSING1']]);
      const part = opExplodeFront1.getParameter('Parts').addElement();
      part.getParameter('Axis').setValue(new Vec3(0, -1, 0));
      part.getOutput().setParam(group.getParameter('GlobalXfo'));
    }
    ...
    {
      const group = new Group('10MM_SPRING_WASHER1s');
      group.getParameter('InitialXfoMode').setValue('average');
      asset.addChild(group);
      group.resolveItems([
        ['.', '10MM_SPRING_WASHER1'],
    ...
    }
    {
      ...
      group.getParameter('InitialXfoMode').setValue('average');
      asset.addChild(group);
      group.resolveItems([['.', 'NEEDLE_BEARING_ASSM_ASM1']]);
      const part = opExplodeBack1.getParameter('Parts').addElement();
      part.getParameter('Axis').setValue(new Vec3(0, 1, 0));
      part.getOutput().setParam(group.getParameter('GlobalXfo'));
    }
