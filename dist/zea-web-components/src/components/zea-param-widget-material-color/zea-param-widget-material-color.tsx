...
@Component({
  tag: 'zea-param-widget-material-color',
  styleUrl: 'zea-param-widget-material-color.css',
  shadow: true,
})
  ...
  render() {
    ...
    return (
      <div
        ...
        class="zea-param-widget-material-color"
      >
        <div
          style={{
...
uxFactory.registerWidget(
  ...
  (p) => p.constructor.name == MaterialColorParam.name
)
