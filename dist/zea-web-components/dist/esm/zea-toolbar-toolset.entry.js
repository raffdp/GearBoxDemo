...
const ZeaToolbar = class {
    ...
    render() {
        ...
        return (h("div", { class: "zea-toolset", ref: (el) => (this.toolsetElement = el) }, h("div", { class: "current", ref: (el) => (this.currentContainer = el) }), h("div", { class: "children", ref: (el) => (this.childrenContainer = el) }, toolKeys &&
