...
const ZeaToolbarColorpicker = class {
    ...
    render() {
        ...
        return (h("div", { class: "zea-colopicker", ref: (el) => (this.colopickerElement = el) }, h("div", { class: "current", ref: (el) => (this.currentContainer = el) }), h("div", { class: "children", style: { display: this.displayChildren ? 'grid' : 'none' }, ref: (el) => (this.childrenContainer = el) }, colorKeys &&
