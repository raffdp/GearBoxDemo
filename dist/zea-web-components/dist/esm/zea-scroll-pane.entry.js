...
const ZeaScrollPane = class {
     ...
     */
    render() {
        return (h(Host, null, h("div", { ref: (el) => (this.vScrollTrack = el), draggable: false, class: "v-scroll-track" }), h("div", { draggable: false, class: "v-scroll-bar", ref: (el) => (this.vScrollBar = el) }), h("div", { class: "zea-scroll-pane", ref: (el) => (this.scrollPane = el) }, h("div", { class: "scroll-content", ref: (el) => (this.scrollContent = el) }, h("slot", null)))));
    }
    get rootElement() { return getElement(this); }
};
ZeaScrollPane.style = zeaScrollPaneCss;

export { ZeaScrollPane as zea_scroll_pane };
