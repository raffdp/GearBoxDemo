...
const ZeaFileSystemBrowser = class {
    ...
    render() {
        ...
        return (h("div", { class: {
            ...
            } }, h("ion-icon", { name: "settings-sharp" })), h("ion-button", { fill: "clear", title: "View as list" }, h("ion-icon", { name: "list-sharp" }))), h("div", { class: "ZeaFileSystemBrowser__breadcrumbs" }, h("zea-breadcrumbs", { project: this.project, folder: this.folder })), h("div", { class: "mh3" }, h("div", { class: "mb4" }, h("p", { class: "ZeaFileSystemBrowser__section-title" }, "Folders"), folders.length ? (h("div", { class: "ZeaFileSystemBrowser__fs-objects" }, folders.map((folder) => (h("zea-thumbnail", { icon: h("ion-icon", { name: "folder" }), zeaModelInstance: folder, onDblClickThumbnail: () => {
                this.folderId = folder.id;
                this.changeFolder.emit(folder);
            } }))))) : (h("div", null, "No folders."))), h("div", { class: "mb4" }, h("p", { class: "ZeaFileSystemBrowser__section-title" }, "Files"), files.length ? (h("div", { class: "ZeaFileSystemBrowser__fs-objects" }, files.map((file) => (h("zea-thumbnail", { icon: h("ion-icon", { name: "document" }), zeaModelInstance: file, zeaSession: this.zeaSession, onDblClickThumbnail: () => {
            ...
            } }, "App Store"), ((_a = this.project.connectedApps) === null || _a === void 0 ? void 0 : _a.length) > 0 ? (h("div", null, h("div", { class: "mb3" }, "The apps below have been connected to this project."), h("ion-list", null, this.project.connectedApps.map((appId) => {
            return (h("ion-item", null, h("ion-label", null, appId), h("ion-button", { class: "dark-red", fill: "clear", slot: "end", title: "Remove", onClick: async () => {
                    await this.project.disconnectApp(appId);
                } }, h("ion-icon", { name: "close-circle-sharp" }))));
        })))) : (h("div", null, "No apps have been connected to this project."))), h("div", { slot: "tab-bar" }, "Storage"), h("div", null), h("div", { slot: "tab-bar" }, "Advanced"), h("div", null))))), this.showAppStoreDialog && (h("zea-dialog", { shown: true, width: "75%" }, h("div", { slot: "title" }, "App Store"), h("div", { slot: "body" }, h("ul", { class: "list pl0 flex flex-wrap" }, this.availableApps.map((app) => (h("li", null, h("button", { class: "AppItem br2 grow shadow-hover mb3 mr3 pa0", title: app.name, type: "button", onClick: async () => {
            ...
            } }), h("div", { class: "AppItem__Footer flex f6 items-center pa1" }, h("span", { class: "AppItem__Name" }, app.name)))))))))), this.currentApp && (h("zea-dialog", { shown: true, width: "80%" }, h("div", { class: "flex items-center", slot: "title" }, h("span", { class: "flex-auto" }, this.currentApp.name), h("ion-button", { onClick: async () => {
