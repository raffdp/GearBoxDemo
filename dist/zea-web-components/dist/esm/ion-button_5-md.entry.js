...
const ZeaBreadcrumbs = class {
    ...
    render() {
        ...
        return (h("div", { class: "ZeaBreadcrumbs" }, ZeaBreadcrumbs.breadcrumbEl(this.project.name), ancestors.length > 0 &&
            ancestors.map((folder) => (h("span", null, h("ion-icon", { name: "arrow-dropright" }), ZeaBreadcrumbs.breadcrumbEl(folder.name))))));
    }
};
...
const ZeaThumbnail = class {
    ...
    subToFileProgress() {
        ...
        this.zeaSession.sub(o.actions.FILE_WITH_PROGRESS, (payload) => {
