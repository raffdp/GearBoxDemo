...
const ZeaMenu = class {
     ...
     */
    render() {
        const anchor = this.type == 'contextual' && this.showAnchor ? (index.h("div", { onMouseUp: this.handleAnchorClick.bind(this), class: "menu-anchor", ref: (el) => (this.anchorElement = el) }, index.h("zea-icon", { name: this.anchorIcon }))) : null;
        const menuClass = {};
...
const ZeaMenuSeparator = class {
     ...
     */
    render() {
        return (index.h("div", { class: `zea-menu-separator ${this.class} ${this.orientation}` }, index.h("div", { class: "ruler" })));
    }
};
...
exports.zea_menu_separator = ZeaMenuSeparator;
