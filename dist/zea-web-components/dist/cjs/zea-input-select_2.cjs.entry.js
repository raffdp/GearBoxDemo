...
const ZeaInputSelect = class {
     ...
     */
    render() {
        return (index.h("div", { class: `input-wrap ${this.value ? 'not-empty' : 'empty'} ${this.optionsShown ? 'focused' : ''}`, ref: (el) => (this.inputWrapElement = el) }, this.showLabel && index.h("label", { class: "input-label" }, this.label), index.h("div", { ref: (el) => (this.selectionContainer = el), class: "selection-container", onClick: this.onContainerClick.bind(this) }, index.h("div", { class: "selection" }), index.h("zea-icon", { name: this.optionsShown ? 'chevron-up-outline' : 'chevron-down-outline', size: 13 })), index.h("div", { ref: (el) => (this.optionsContainer = el), class: { 'options-container': true, shown: this.optionsShown } }, index.h("zea-scroll-pane", null, index.h("slot", null))), index.h("div", { class: "underliner" }, index.h("div", { class: "expander" })), !this.isValid && this.invalidMessageShown && (index.h("div", { class: "invalid-message" }, this.invalidMessage))));
    }
};
...
const ZeaInputSelectItem = class {
     ...
     */
    render() {
        return (index.h("div", { class: "zea-input-select-item" }, index.h("slot", null)));
    }
};
ZeaInputSelectItem.style = zeaInputSelectItemCss;

exports.zea_input_select = ZeaInputSelect;
exports.zea_input_select_item = ZeaInputSelectItem;
