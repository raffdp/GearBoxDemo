...
const ZeaDialog = class {
    ...
    render() {
        return (index.h("div", { class: {
            ...
            } }, this.showBackdrop && (index.h("div", { class: "backdrop", onClick: this.onBackdropClick.bind(this) })), index.h("div", { class: "zea-dialog-container", ref: (el) => this.setupContainer(el) }, index.h("div", { class: "zea-dialog-title" }, index.h("slot", { name: "title" })), index.h("div", { class: "zea-dialog-body" }, index.h("slot", { name: "body" })), index.h("div", { class: "zea-dialog-footer" }, index.h("slot", { name: "footer" })))));
    }
