...
const ZeaWcDataConnector = require('./ZeaWcDataConnector-9119ee33.js');
...
const ZeaFormDisciplinesSettings = class {
    constructor(hostRef) {
        ...
        this.abbrElements = {};
        this.colorElements = {};
        this.dialogResize = index.createEvent(this, "dialogResize", 7);
    }
    /**
     */
     ...
     */
    render() {
        return (index.h("div", { class: "zea-form-disciplines-settings" }, index.h("div", { class: "form-top" }, index.h("div", null, index.h("zea-input-text", { ref: (el) => (this.abbrInput = el), label: "Abbreviation", id: "abbreviation-input" })), index.h("div", null, index.h("zea-input-text", { ref: (el) => (this.nameInput = el), label: "Discipline", id: "disciplines-input" })), index.h("div", null, index.h("zea-input", { ref: (el) => (this.colorInput = el), type: "color", label: "Color", showLabel: false, colorPopupAlign: "top-left" })), index.h("div", null, index.h("zea-button", { variant: "solid", onClick: this.saveDiscipline.bind(this) }, "ADD NEW")), index.h("div", null, index.h("zea-menu-separator", { orientation: "vertical" })), index.h("div", null, index.h("zea-menu", { type: "contextual", contextualAlign: "top-right", showAnchor: true, anchorIcon: "ellipsis-vertical" }, index.h("zea-menu-item", { onClick: this.resetDefatuls.bind(this) }, index.h("zea-icon", { name: "refresh-circle-outline" }), " Restore Defaults")))), index.h("div", { class: "form-bottom" }, index.h("zea-scroll-pane", null, this.disciplines.map((discipline) => {
            return [
                index.h("div", { ref: (el) => (this.rowElements[discipline._id] = el), class: "discipline-row", id: discipline._id, key: discipline._id }, index.h("div", { class: "discipline-abbreviation", style: { backgroundColor: discipline.color } }, discipline.abbreviation), index.h("div", { class: "discipline-name" }, discipline.name), index.h("div", { class: "discipline-tools" }, index.h("zea-icon", { name: "create-outline", size: 18, onClick: () => {
                        this.editRowElements[discipline._id].style.display =
                            'flex';
                        this.rowElements[discipline._id].style.display = 'none';
                    } }), index.h("zea-icon", { size: 18, name: "trash-outline", onClick: () => {
                        this.deleteDisclipline(discipline._id);
                    } }))),
                index.h("div", { ref: (el) => (this.editRowElements[discipline._id] = el), class: "discipline-edit-row", id: `${discipline._id}-editor`, key: `${discipline._id}-editor` }, index.h("div", null, index.h("zea-input-text", { ref: (el) => (this.abbrElements[discipline._id] = el), label: "Abbreviation", id: "abbreviation-input", value: discipline.abbreviation })), index.h("div", null, index.h("zea-input-text", { ref: (el) => (this.nameElements[discipline._id] = el), label: "Discipline", value: discipline.name, id: "disciplines-input" })), index.h("div", null, index.h("zea-input", { ref: (el) => (this.colorElements[discipline._id] = el), type: "color", label: "Color", showLabel: false, value: discipline.color, colorPopupAlign: "top-left" })), index.h("div", { class: "discipline-edit-tools" }, index.h("zea-icon", { name: "checkmark-outline", size: 20, onClick: () => {
                        this.editRowElements[discipline._id].style.display =
                            'none';
                        this.rowElements[discipline._id].style.display = 'flex';
                        this.updateDiscipline(discipline._id);
                    } }), index.h("zea-icon", { size: 20, name: "close-outline", onClick: () => {
                        this.editRowElements[discipline._id].style.display =
                            'none';
                        this.rowElements[discipline._id].style.display = 'flex';
                    } }))),
...
const ZeaFormMeasurementsSettings = class {
     ...
     */
    render() {
        return index.h("div", { class: "zea-form-measurements-settings" }, this.test);
    }
};
ZeaFormMeasurementsSettings.style = zeaFormMeasurementsSettingsCss;

exports.zea_form_disciplines_settings = ZeaFormDisciplinesSettings;
exports.zea_form_measurements_settings = ZeaFormMeasurementsSettings;
