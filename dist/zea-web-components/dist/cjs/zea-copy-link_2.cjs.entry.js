...
const ZeaCopyLink = class {
    ...
    render() {
        ...
        return (index.h("div", { class: "zea-copy-link" }, index.h("div", { class: "label" }, "Copy Link"), index.h("div", { class: "link-container" }, index.h("input", { onClick: this.onLinkClick.bind(this), readOnly: true, class: "link", ref: (el) => (this.linkInput = el), value: this.link }), index.h("div", { class: { active: this.tooltipIsVisible, 'copy-icon': true }, onClick: this.onCopyClick.bind(this) }, index.h("zea-icon", { name: "copy-outline" }), index.h("div", { class: { tooltip: true } }, this.tooltipText)))));
    }
};
...
var errorCorrectionLevel = global.createCommonjsModule(function (module, exports) {
exports.L = { bit: 1 };
exports.M = { bit: 0 };
exports.Q = { bit: 3 };
exports.H = { bit: 2 };
...
var alignmentPattern = global.createCommonjsModule(function (module, exports) {
/**
...
var maskPattern = global.createCommonjsModule(function (module, exports) {
/**
...
var polynomial = global.createCommonjsModule(function (module, exports) {
/**
...
var mode = global.createCommonjsModule(function (module, exports) {
/**
...
var version = global.createCommonjsModule(function (module, exports) {
...
var dijkstra_1 = global.createCommonjsModule(function (module) {
...
var segments = global.createCommonjsModule(function (module, exports) {
/**
...
var utils$1 = global.createCommonjsModule(function (module, exports) {
...
var canvas = global.createCommonjsModule(function (module, exports) {
...
const ZeaQrCode = class {
     ...
     */
    render() {
        return (index.h("div", { class: "zea-qr-code", ref: (el) => (this.container = el) }));
    }
    static get watchers() { return {
        "content": ["onContentChanged"]
    }; }
};
ZeaQrCode.style = zeaQrCodeCss;

exports.zea_copy_link = ZeaCopyLink;
exports.zea_qr_code = ZeaQrCode;
