...
const events = require('./events-0d0d5b33.js');
...
function load() {
	...
	if (!r && typeof events.process !== 'undefined' && 'env' in events.process) {
		r = events.process.env.DEBUG;
	}
...
var componentEmitter$1 = global.createCommonjsModule(function (module) {
/**
 * Expose `Emitter`.
 */
...
var browser$3 = global.createCommonjsModule(function (module, exports) {
/* eslint-env browser */
...
var componentEmitter$2 = global.createCommonjsModule(function (module) {
/**
 * Expose `Emitter`.
 */
