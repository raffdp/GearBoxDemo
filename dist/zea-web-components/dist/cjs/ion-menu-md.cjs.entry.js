...
`);
    ...
    setOpen(shouldOpen, animated = true) {
        return index$2.menuController._setOpen(this, shouldOpen, animated);
    }
    ...
    async loadAnimation() {
        ...
        this.animation = await index$2.menuController._createAnimation(this.type, this);
    ...
    updateState() {
        ...
        if (!this.disabled) {
            index$2.menuController._setActiveMenu(this);
        }
