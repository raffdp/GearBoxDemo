...
const index$2 = require('./index-68639f33.js');
...
const Nav = class {
    ...
    async componentDidLoad() {
        this.rootChanged();
        this.gesture = (await new Promise(function (resolve) { resolve(require('./swipe-back-25c92bd6.js')); })).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
