...
const zeaScrollPaneCss = ":host{max-height:100%;width:100%;display:block;position:relative;height:100%}:host(.disabled){height:auto}.zea-scroll-pane{pointer-events:auto;max-height:100%;overflow:auto;scrollbar-width:none;-ms-overflow-style:none;}.zea-scroll-pane::-webkit-scrollbar{width:0px;background:transparent;}.v-scroll-track{position:absolute;right:0;top:0;bottom:0;width:10px;background-color:var(--color-background-4);z-index:1000}.v-scroll-bar{position:absolute;right:0px;width:10px;top:0;background-color:var(--color-grey-3);z-index:10000;-webkit-box-shadow:-2px 4px 7px -3px var(--color-background-1);box-shadow:-2px 4px 7px -3px var(--color-background-1)}:host(.disabled) .v-scroll-track,:host(.disabled) .v-scroll-bar{display:none}";

const ZeaScrollPane = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
     ...
     */
    render() {
        return (index.h(index.Host, null, index.h("div", { ref: (el) => (this.vScrollTrack = el), draggable: false, class: "v-scroll-track" }), index.h("div", { draggable: false, class: "v-scroll-bar", ref: (el) => (this.vScrollBar = el) }), index.h("div", { class: "zea-scroll-pane", ref: (el) => (this.scrollPane = el) }, index.h("div", { class: "scroll-content", ref: (el) => (this.scrollContent = el) }, index.h("slot", null)))));
    }
...
exports.zea_scroll_pane = ZeaScrollPane;
