...
const zeaBreadcrumbsCss = ":host,input,button,select,textarea{font-family:'Roboto', sans-serif}.ZeaBreadcrumbs{display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap;padding:1rem}.ZeaBreadcrumbs a{color:var(--ion-color-primary)}";

const ZeaBreadcrumbs = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.clickFolder = index.createEvent(this, "clickFolder", 7);
    }
    /**
    ...
    static breadcrumbEl(text) {
        return (index.h("a", { href: "#", onClick: (evt) => {
                evt.preventDefault();
            } }, text));
    }
    /**
    ...
    render() {
        ...
        return (index.h("div", { class: "ZeaBreadcrumbs" }, ZeaBreadcrumbs.breadcrumbEl(this.project.name), ancestors.length > 0 &&
            ancestors.map((folder) => (index.h("span", null, index.h("ion-icon", { name: "arrow-dropright" }), ZeaBreadcrumbs.breadcrumbEl(folder.name))))));
    }
};
...
const ZeaThumbnail = class {
    ...
    constructor(hostRef) {
        ...
        this.clickThumbnail = index.createEvent(this, "clickThumbnail", 7);
        this.dblClickThumbnail = index.createEvent(this, "dblClickThumbnail", 7);
    }
    ...
    subToFileProgress() {
        ...
        this.zeaSession.sub(zeaCollab_esm.o.actions.FILE_WITH_PROGRESS, (payload) => {
    ...
    render() {
        return (index.h("div", { class: {
            ...
            }, title: this.zeaModelInstance.name, onClick: this.handleClick, onDblClick: this.handleDblClick }, this.zeaModelInstance.thumbnail && (index.h("div", { class: "ZeaThumbnail__thumbnail", style: {
                backgroundImage: `url("${this.zeaModelInstance.thumbnail}")`,
            } })), index.h("div", { class: "ZeaThumbnail__footer" }, index.h("span", { class: "ZeaThumbnail__icon" }, this.icon), index.h("span", { class: "ZeaThumbnail__name" }, this.zeaModelInstance.name)), this.fileProgress && (index.h("div", { class: "ZeaThumbnail__progress", style: {
...
exports.zea_breadcrumbs = ZeaBreadcrumbs;
exports.zea_images_gallery = ZeaImagesGallery;
exports.zea_markdown_viewer = ZeaMarkdownViewer;
exports.zea_thumbnail = ZeaThumbnail;
