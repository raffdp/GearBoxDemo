...
const cubicBezier = require('./cubic-bezier-f3b34d27.js');
const frameworkDelegate = require('./framework-delegate-84d33ff0.js');
const index$2$1 = require('./index-68639f33.js');
...
const RouterOutlet = class {
    ...
    async connectedCallback() {
        this.gesture = (await new Promise(function (resolve) { resolve(require('./swipe-back-25c92bd6.js')); })).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart() && this.animationEnabled, () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
    ...
    async transition(enteringEl, leavingEl, opts = {}) {
        ...
        await index$2$1.transition(Object.assign({ mode,
            animated,
            animationBuilder,
            enteringEl,
