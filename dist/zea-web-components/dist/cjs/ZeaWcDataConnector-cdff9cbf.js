...
const index$1 = require('./index-7e350ca9.js');
const events = require('./events-0d69a2c7.js');

var Mutation = global.commonjsGlobal.MutationObserver || global.commonjsGlobal.WebKitMutationObserver;
...

{
  if (Mutation) {
    ...
    var element = global.commonjsGlobal.document.createTextNode('');
  ...
  } else if (!global.commonjsGlobal.setImmediate && typeof global.commonjsGlobal.MessageChannel !== 'undefined') {
    var channel = new global.commonjsGlobal.MessageChannel();
    channel.port1.onmessage = nextTick;
    scheduleDrain = function () {
      channel.port2.postMessage(0);
    };
  } else if ('document' in global.commonjsGlobal && 'onreadystatechange' in global.commonjsGlobal.document.createElement('script')) {
    scheduleDrain = function () {

      // Create a <script> element; its readystatechange event will be fired asynchronously once it is inserted
      // into the document. Do so, thus queuing up the task. Remember to clean up once it's been called.
      var scriptEl = global.commonjsGlobal.document.createElement('script');
      ...
      global.commonjsGlobal.document.documentElement.appendChild(scriptEl);
    };
  } else {
    scheduleDrain = function () {
...
var rngBrowser = global.createCommonjsModule(function (module) {
...
var sparkMd5 = global.createCommonjsModule(function (module, exports) {
(function (factory) {
    {
        // Node/CommonJS
...
var inherits_browser = global.createCommonjsModule(function (module) {
...
var setImmediateShim = global.global.setImmediate || global.global.setTimeout;
  ...
  api.getAttachment = adapterFun$$1('getAttachment', function (docId, attachmentId,
    ...
    ourFetch(url, {method: 'GET'}).then(function (response) {
      ...
      if (!response.ok) {
        ...
        if (typeof index$1.process !== 'undefined' && !index$1.process.browser && typeof response.buffer === 'function') {
          return response.buffer();
        } else {
          /* istanbul ignore next */
          return response.blob();
      ...
      // TODO: also remove
      if (typeof index$1.process !== 'undefined' && !index$1.process.browser) {
...
inherits_browser(Changes$2, events.EventEmitter);
...
exports.ZeaWcDataConnector = ZeaWcDataConnector;
