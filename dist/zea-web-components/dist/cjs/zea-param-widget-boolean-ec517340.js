...
const ZeaParamWidgetBoolean = class {
    ...
    inputChanged() {
        if (this.appData.undoRedoManager) {
            const change = new index_esm.N(this.parameter, this.cheboxInput.checked);
...
UxFactory.uxFactory.registerWidget('zea-param-widget-boolean', (p) => p.constructor.name == index_esm.Xe.name);
