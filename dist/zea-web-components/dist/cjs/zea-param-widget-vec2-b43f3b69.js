...
const ZeaParamWidgetVec2 = class {
     ...
     */
    onInput() {
        const value = new index_esm._(this.xField.valueAsNumber, this.yField.valueAsNumber);
        if (!this.change) {
...
UxFactory.uxFactory.registerWidget('zea-param-widget-vec2', (p) => p.constructor.name == index_esm.ye.name);
