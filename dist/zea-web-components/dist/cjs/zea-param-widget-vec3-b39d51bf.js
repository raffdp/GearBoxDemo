...
const ZeaParamWidgetVec3 = class {
     ...
     */
    onInput() {
        const value = new zeaUx_esm.Z(this.xField.valueAsNumber, this.yField.valueAsNumber, this.zField.valueAsNumber);
        if (!this.change) {
...
UxFactory.uxFactory.registerWidget('zea-param-widget-vec3', (p) => p.constructor.name == zeaUx_esm.Ie.name);
