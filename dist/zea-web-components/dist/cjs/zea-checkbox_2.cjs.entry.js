...
const ZeaCheckbox = class {
    ...
    render() {
        return (index.h("div", { class: 'zea-checkbox ' + this.elementClass, onClick: () => {
                this.toggleCheck();
            } }, index.h("span", { class: "zea-checkbox-wrap" }, index.h("span", { class: "zea-checkbox-icon" }, index.h("svg", { xmlns: "http://www.w3.org/2000/svg", width: "100%", height: "100%", viewBox: "0 0 24 24" }, index.h("path", { class: "icon-path", d: "M9 21.035l-9-8.638 2.791-2.87 6.156 5.874 12.21-12.436 2.843 2.817z" })))), index.h("input", { type: "checkbox", name: this.name })));
    }
