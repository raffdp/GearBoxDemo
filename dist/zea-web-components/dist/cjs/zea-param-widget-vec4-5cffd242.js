...
const ZeaParamWidgetVec4 = class {
     ...
     */
    onInput() {
        const value = new index_esm.G(this.xField.valueAsNumber, this.yField.valueAsNumber, this.zField.valueAsNumber, this.tField.valueAsNumber);
        if (!this.change) {
...
UxFactory.uxFactory.registerWidget('zea-param-widget-vec4', (p) => p.constructor.name == index_esm.Ve.name);
