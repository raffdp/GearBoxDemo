...
import { ValueSetMode, Color, MaterialColorParam } from '@zeainc/zea-engine';
import { ParameterValueChange } from '@zeainc/zea-ux';
/**
 * Main class for the component
 */
export class ZeaParamWidgetMaterialColor {
    constructor() {
    ...
    render() {
        clearTimeout(this.resizeTimeout);
        this.resizeTimeout = setTimeout(() => this.resizeColorPicker(), 500);
        return (h("div", { ref: (el) => (this.container = el), class: "zea-param-widget-material-color" },
            h("div", { style: {
    ...
    static get is() { return "zea-param-widget-material-color"; }
    static get encapsulation() { return "shadow"; }
    static get originalStyleUrls() { return {
        "$": ["zea-param-widget-material-color.css"]
    }; }
...
uxFactory.registerWidget('zea-param-widget-material-color', (p) => p.constructor.name == MaterialColorParam.name);
