...
import { o } from './zea-collab.esm-2f7d107f.js';
...
var zeaBreadcrumbsCss = ":host,input,button,select,textarea{font-family:'Roboto', sans-serif}.ZeaBreadcrumbs{display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap;padding:1rem}.ZeaBreadcrumbs a{color:var(--ion-color-primary)}";
var ZeaBreadcrumbs = /** @class */ (function () {
    function ZeaBreadcrumbs(hostRef) {
        registerInstance(this, hostRef);
        this.clickFolder = createEvent(this, "clickFolder", 7);
    }
    /**
     ...
     */
    ZeaBreadcrumbs.breadcrumbEl = function (text) {
        return (h("a", { href: "#", onClick: function (evt) {
                evt.preventDefault();
            } }, text));
    };
    /**
...
var ZeaImagesGallery = /** @class */ (function () {
     ...
     */
    ZeaImagesGallery.isFileImage = function (file) {
     ...
     */
    ZeaImagesGallery.getImageUrl = function (image) {
        var BUCKET_NAME = 'zea-drive-staging-projects-assets';
        var BASE_URL = "https://storage.googleapis.com/" + BUCKET_NAME + "/";
        return "" + BASE_URL + image.idInStorage;
    };
    /**
     * Take image back to original location
     */
    ZeaImagesGallery.prototype.resetImageLocation = function () {
     ...
     */
    ZeaImagesGallery.prototype.zoomImageIn = function (event, image) {
        var _this = this;
        ...
        setTimeout(function () {
            _this.zoomedImageClass = 'zea-ig-zoomed active animate';
            _this.zoomedTop = '0px';
            _this.zoomedLeft = '0px';
            _this.zoomedWidth = '100%';
            _this.zoomedHeight = '100%';
            _this.zoomedOpacity = '1';
        }, 100);
    };
    /**
     * Zoom image out
     */
    ZeaImagesGallery.prototype.zoomImageOut = function () {
        var _this = this;
        this.resetImageLocation();
        setTimeout(function () {
            _this.zoomedImageClass = 'zea-ig-zoomed inactive';
        }, 400);
    };
    /**
     ...
     */
    ZeaImagesGallery.prototype.render = function () {
        var _this = this;
        var onlyImages = Object.values(this.folder.children).filter(ZeaImagesGallery.isFileImage);
        var rowsCount = Math.ceil((onlyImages.length + this.featured * 3) / this.columns);
        return (h(Host, { class: "ZeaImagesGallery" }, h("div", { class: this.zoomedImageClass, style: {
                top: this.zoomedTop,
            ...
            } }, onlyImages.map(function (image, i) { return (h("div", { style: {
                backgroundImage: "url(" + ZeaImagesGallery.getImageUrl(image) + ")",
            }, class: "zea-ig-image " + (i < _this.featured ? ' featured' : ''), onClick: function (event) {
                _this.zoomImageIn(event, image);
            }, title: image.name })); }))));
    };
    return ZeaImagesGallery;
}());
...
var zeaMarkdownViewerCss = ":host{display:block;color:var(--color-foreground-1)}:host,input,button,select,textarea{font-family:'Roboto', sans-serif}a{color:var(--color-primary-1)}";
var ZeaMarkdownViewer = /** @class */ (function () {
    function ZeaMarkdownViewer(hostRef) {
        registerInstance(this, hostRef);
    }
    /**
     ...
     */
    ZeaMarkdownViewer.prototype.convertMdToHtml = function () {
        var mdConverter = new Remarkable();
     ...
     * @return {JSX} the generated html
     */
    ZeaMarkdownViewer.prototype.render = function () {
        var convertedText = this.convertMdToHtml();
        return h("div", { innerHTML: convertedText });
    };
    return ZeaMarkdownViewer;
}());
ZeaMarkdownViewer.style = zeaMarkdownViewerCss;
...
var ZeaThumbnail = /** @class */ (function () {
    ...
    ZeaThumbnail.prototype.subToFileProgress = function () {
        ...
        this.zeaSession.sub(o.actions.FILE_WITH_PROGRESS, function (payload) {
...
export { Button as ion_button, ZeaBreadcrumbs as zea_breadcrumbs, ZeaImagesGallery as zea_images_gallery, ZeaMarkdownViewer as zea_markdown_viewer, ZeaThumbnail as zea_thumbnail };
