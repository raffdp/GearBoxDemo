...
var ZeaParameterContainer = /** @class */ (function () {
     ...
     */
    ZeaParameterContainer.prototype.render = function () {
        var _this = this;
        return (h("div", { class: "zea-parameter-container" }, this.parameterOwner.getParameters().map(function (parameter, index) {
            var parameterName = parameter.getName();
            var reg = uxFactory.findWidgetReg(parameter);
            if (!reg) {
                return (h("div", null, "Unable to display parameter '", parameterName, "', value:", parameter.getValue(), ", index: ", index));
            }
            return (h("div", { class: "zea-param-widget-wrap " + reg.widget + "-wrap" }, h("label", { htmlFor: parameterName }, parameterName), h("div", { class: "zea-parameter-input-wrap" }, h(reg.widget, { id: parameterName, key: index, appData: _this.appData, parameter: parameter }))));
        })));
    };
    return ZeaParameterContainer;
}());
