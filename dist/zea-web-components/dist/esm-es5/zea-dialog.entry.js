...
var ZeaDialog = /** @class */ (function () {
    ...
    /**
     */
    class_1.prototype.closeDialog = function () {
        if (this.allowClose) {
            this.shown = false;
    ...
    class_1.prototype.render = function () {
        ...
        return (h("div", { class: {
            ...
            } }, this.showBackdrop && (h("div", { class: "backdrop", onClick: this.closeDialog.bind(this) })), h("div", { class: {
                'zea-dialog-container': true,
                'full-screen-mobile': this.fullScreenMobile,
            }, ref: function (el) { return _this.setupContainer(el); } }, this.showTitle && (h("div", { class: "zea-dialog-title" }, this.allowClose && (h("zea-icon", { name: "arrow-back", onClick: this.closeDialog.bind(this) })), h("slot", { name: "title" }))), h("div", { class: "zea-dialog-body" }, h("slot", { name: "body" })), h("div", { class: "zea-dialog-footer" }, h("slot", { name: "footer" })))));
    };
