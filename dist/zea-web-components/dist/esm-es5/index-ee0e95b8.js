...
import { c as createCommonjsModule, g as getCjsExportFromNamespace } from './global-eddac5e6.js';
import { p as process, r as require$$0 } from './events-a71dfb91.js';
...
function setup$1(env) {
    ...
    */
    function selectColor(namespace) {
        var hash = 0;
        for (var i_2 = 0; i_2 < namespace.length; i_2++) {
            hash = ((hash << 5) - hash) + namespace.charCodeAt(i_2);
            hash |= 0; // Convert to 32bit integer
        }
        return createDebug.colors[Math.abs(hash) % createDebug.colors.length];
    }
...
export { socketioWildcard as e, lib$1 as s };
