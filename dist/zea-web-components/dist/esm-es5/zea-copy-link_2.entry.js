...
var ZeaCopyLink = /** @class */ (function () {
    ...
    /**
     */
    ZeaCopyLink.prototype.onCopyClick = function () {
        var _this = this;
        ...
        setTimeout(function () {
            ...
            _this.tooltipText = 'Copy Link';
        }, this.tooltipDelay);
    };
    /**
     */
    ZeaCopyLink.prototype.onLinkClick = function () {
        /* Select the text field */
        this.linkInput.select();
    ...
    /**
     */
    ZeaCopyLink.prototype.render = function () {
        var _this = this;
        if (!this.link) {
            this.link = window.location.href;
        }
        return (h("div", { class: "zea-copy-link" }, h("div", { class: "label" }, "Copy Link"), h("div", { class: "link-container" }, h("input", { onClick: this.onLinkClick.bind(this), readOnly: true, class: "link", ref: function (el) { return (_this.linkInput = el); }, value: this.link }), h("div", { class: { active: this.tooltipIsVisible, 'copy-icon': true }, onClick: this.onCopyClick.bind(this) }, h("zea-icon", { name: "copy-outline" }), h("div", { class: { tooltip: true } }, this.tooltipText)))));
    };
    return ZeaCopyLink;
}());
...
var ZeaQrCode = /** @class */ (function () {
     ...
     */
    ZeaQrCode.prototype.onContentChanged = function () {
        this.makeQR();
    };
    /**
     * Runs when component finishes loading
     */
    ZeaQrCode.prototype.componentDidLoad = function () {
        this.makeQR();
    };
    /**
     * Make the QR image as a canvas
     */
    ZeaQrCode.prototype.makeQR = function () {
        var _this = this;
        if (this.canvas)
            this.canvas.remove();
        browser.toCanvas(this.content, { scale: this.scale }).then(function (canvas) {
            _this.canvas = canvas;
     ...
     */
    ZeaQrCode.prototype.render = function () {
        var _this = this;
        return (h("div", { class: "zea-qr-code", ref: function (el) { return (_this.container = el); } }));
    };
    Object.defineProperty(ZeaQrCode, "watchers", {
        get: function () {
            return {
...
export { ZeaCopyLink as zea_copy_link, ZeaQrCode as zea_qr_code };
