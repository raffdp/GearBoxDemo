...
import { p as process } from './index-27446e12.js';
import { B as Buffer } from './buffer-es6-d7e2ddd2.js';
import { r as require$$0 } from './events-accbf876.js';
/**
 * Helpers.
 */
var s = 1000;
...
function setup(env) {
    ...
    */
    function selectColor(namespace) {
        var hash = 0;
        for (var i_1 = 0; i_1 < namespace.length; i_1++) {
            hash = ((hash << 5) - hash) + namespace.charCodeAt(i_1);
    ...
    */
    function disable() {
        var namespaces = __spreadArrays(createDebug.names.map(toNamespace), createDebug.skips.map(toNamespace).map(function (namespace) { return '-' + namespace; })).join(',');
        createDebug.enable('');
        return namespaces;
    }
    /**
...
var i$1 = { JOIN_ROOM: "join-room", PING_ROOM: "ping-room", LEAVE_ROOM: "leave-room" };
var o = /** @class */ (function () {
    function o(s, t) {
        this.userData = s, this.socketUrl = t, this.users = {}, this.userStreams = {}, this.callbacks = {}, this.envIsBrowser = "undefined" != typeof window, this.debugCollab = browser("zea-collab");
    }
    o.prototype.stopCamera = function (e) {
        if (e === void 0) { e = !0; }
        this.stream && (this.stream.getVideoTracks()[0].enabled = !1, e && this.pub(o.actions.USER_VIDEO_STOPPED, {}));
    };
    o.prototype.startCamera = function (e) {
        if (e === void 0) { e = !0; }
        this.stream && (this.stream.getVideoTracks()[0].enabled = !0, e && this.pub(o.actions.USER_VIDEO_STARTED, {}));
    };
    o.prototype.muteAudio = function (e) {
        if (e === void 0) { e = !0; }
        this.stream && (this.stream.getAudioTracks()[0].enabled = !1, e && this.pub(o.actions.USER_VIDEO_STOPPED, {}));
    };
    o.prototype.unmuteAudio = function (e) {
        if (e === void 0) { e = !0; }
        this.stream && (this.stream.getAudioTracks()[0].enabled = !0, e && this.pub(o.actions.USER_AUDIO_STARTED, {}));
    };
    o.prototype.getVideoStream = function (e) { return this.userStreams[e]; };
    o.prototype.setVideoStream = function (e, s) { if (this.userStreams[s])
        return; var t = document.createElement("video"); t.srcObject = e, this.userStreams[s] = t, t.onloadedmetadata = function () { t.play(); }, document.body.appendChild(t); };
    o.concatFullRoomId = function (e, s, t) { return e + (s || "_ALL_FILES_") + (t || "_ALL_ROOMS_"); };
    o.prototype.isJoiningTheSameRoom = function (e, s, t) { return this.fullRoomId === o.concatFullRoomId(e, s, t); };
    o.prototype.joinRoom = function (e, r, a) {
        var _this = this;
        this.projectId = e, this.fileId = r, this.roomId = a, this.fullRoomId = o.concatFullRoomId(this.projectId, this.fileId, this.roomId), this.leaveRoom(), this.socket = lib$1(this.socketUrl, { "sync disconnect on unload": !0, query: "userId=" + this.userData.id + "&roomId=" + this.fullRoomId }), socketioWildcard(lib$1.Manager)(this.socket), this.socket.on("*", function (e) { var _a = e.data, s = _a[0], t = _a[1]; s in i$1 || _this._emit(s, t.payload, t.userId); }), this.envIsBrowser && window.addEventListener("beforeunload", function () { _this.leaveRoom(); }), this.pub(i$1.JOIN_ROOM), this.socket.on(i$1.JOIN_ROOM, function (e) { _this.debugCollab(i$1.JOIN_ROOM + ":\n%O", e); var s = e.userData; _this._addUserIfNew(s), _this.pub(i$1.PING_ROOM); }), this.socket.on(i$1.LEAVE_ROOM, function (e) { _this.debugCollab(i$1.LEAVE_ROOM + ":\n%O", e); var s = e.userData, t = s.id; if (t in _this.users)
            return delete _this.users[t], void _this._emit(o.actions.USER_LEFT, s); _this.debugCollab("Outgoing user was not found in room."); }), this.socket.on(i$1.PING_ROOM, function (e) { _this.debugCollab(i$1.PING_ROOM + ":\n%O", e); var s = e.userData; _this._addUserIfNew(s); });
    };
    o.prototype._prepareMediaStream = function () {
        var _this = this;
        return this.__streamPromise || (this.__streamPromise = new window.Promise(function (e, s) { _this.stream ? e() : navigator.mediaDevices.getUserMedia({ audio: !0, video: { width: 400, height: 300 } }).then(function (s) { _this.stream = s, _this.stopCamera(!1), _this.muteAudio(!1), e(); }).catch(function (e) { s(e); }); })), this.__streamPromise;
    };
    o.prototype.leaveRoom = function () {
        var _this = this;
        this._emit(o.actions.LEFT_ROOM), this.users = {}, this.socket && this.pub(i$1.LEAVE_ROOM, void 0, function () { _this.socket.close(); });
    };
    o.prototype._addUserIfNew = function (e) { e.id in this.users || (this.users[e.id] = e, this._emit(o.actions.USER_JOINED, e)); };
    o.prototype.createRoom = function () { return this.roomId = shortid.generate(), this.joinRoom(this.projectId, this.fileId, this.roomId), this.envIsBrowser && window.history.pushState(null, null, "?project-id=" + this.projectId + "&file-id=" + this.fileId + "&room-id=" + this.roomId), this.roomId; };
    o.prototype.getUsers = function () { return this.users; };
    o.prototype.getUser = function (e) { return this.users[e]; };
    o.prototype.pub = function (e, s, t) { if (!e)
        throw new Error("Missing messageType"); this.socket.emit(e, { userData: this.userData, userId: this.userData.id, payload: s }, t); };
    o.prototype._emit = function (e, s, t) { var i = this.callbacks[e]; i && i.forEach(function (e) { return e(s, t); }); };
    o.prototype.sub = function (e, s) {
        ...
        this.callbacks[e] = this.callbacks[e] || [], this.callbacks[e].push(s);
        return function () { _this.callbacks[e].splice(_this.callbacks[e].indexOf(s), 1); };
    };
    return o;
}());
o.actions = { USER_JOINED: "user-joined", USER_VIDEO_STARTED: "user-video-started", USER_VIDEO_STOPPED: "user-video-stopped", USER_AUDIO_STARTED: "user-audio-started", USER_AUDIO_STOPPED: "user-audio-stopped", USER_LEFT: "user-left", LEFT_ROOM: "left-room", TEXT_MESSAGE: "text-message", POSE_CHANGED: "pose-message", COMMAND_ADDED: "command-added", COMMAND_UPDATED: "command-updated", FILE_WITH_PROGRESS: "file-with-progress" };
var r = /** @class */ (function () {
    function r() {
    }
    r.setSocketURL = function (e) { this.socketUrl = e; };
    r.getInstance = function (e, s, t, i) { if (!this.session) {
        if (!this.socketUrl)
            throw new Error("Missing #socketUrl. Call #setSocketURL first.");
        this.session = new o(e, this.socketUrl);
    } return this.session.isJoiningTheSameRoom(s, t, i) || this.session.joinRoom(s, t, i), this.session; };
    r.getCurrentSession = function () { return this.session; };
    return r;
}());
export { o, r };
