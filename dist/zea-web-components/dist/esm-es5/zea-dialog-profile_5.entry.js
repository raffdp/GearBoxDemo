...
var zeaDialogProfileCss = ":host,input,button,select,textarea{font-family:'Roboto', sans-serif}.zea-dialog-profile{color:var(--color-foreground-1)}.scrollpane-container{width:100%;height:calc(100% - 3em);padding:10px;-webkit-box-sizing:border-box;box-sizing:border-box}";
var ZeaProfileDialog = /** @class */ (function () {
    ...
    ZeaProfileDialog.prototype.render = function () {
        return (h("div", { class: "zea-dialog-profile" }, h("zea-dialog", { width: "320px", allowClose: this.allowClose, showBackdrop: true, shown: this.shown, addPadding: false }, h("div", { slot: "title" }, "My Profile"), h("div", { slot: "body" }, h("div", { class: "scrollpane-container" }, h("zea-scroll-pane", null, h("zea-form-profile", { userData: this.userData, showLabels: this.showLabels, welcomeHtml: "" })))))));
    };
...
var ZeaProfileForm = /** @class */ (function () {
    ...
    ZeaProfileForm.prototype.render = function () {
        var _this = this;
        return (h("div", { class: "zea-form-profile" }, h("zea-form", { ref: function (el) { return (_this.formElement = el); }, id: "quick-access-form", submitCallback: this.submitCallback.bind(this), "submit-text": this.submitButtonText, validate: true }, this.welcomeHtml && h("div", { innerHTML: this.welcomeHtml }), h("zea-input-text", { id: "quick-access-id", name: "id", showLabel: false, hidden: true, value: this.userData.id || '' }), h("zea-input-text", { id: "quick-access-name", label: "First Name (required)", name: "firstName", showLabel: true, required: true, value: this.userData.firstName || '' }), h("zea-input-text", { id: "quick-access-lastname", label: "Last Name", showLabel: this.showLabels, name: "lastName", value: this.userData.lastName || '' }), h("zea-input-text", { id: "quick-access-email", label: "Email", showLabel: this.showLabels, name: "email", value: this.userData.email || '' }), h("zea-input-text", { id: "quick-access-phone", label: "Phone", showLabel: this.showLabels, name: "phone", value: this.userData.phone || '' }), h("zea-input-text", { id: "quick-access-company", label: "Company", showLabel: this.showLabels, name: "company", value: this.userData.company || '' }), h("zea-input", { id: "quick-access-photo", type: "photo", label: "Photo", showLabel: this.showLabels, name: "avatar", value: this.userData.avatar || '' }), h("zea-input", { id: "quick-access-color", type: "color", label: "Color", showLabel: this.showLabels, name: "color", value: this.userData.color || '' }))));
    };
...
var ZeaUserChip = /** @class */ (function () {
     ...
     */
    ZeaUserChip.prototype.onChipClick = function (e) {
